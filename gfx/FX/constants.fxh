...
static const float 	SNOW_OPACITY_MIN			= 0.45f; //EIM 0.95f
static const float 	SNOW_OPACITY_MAX			= 0.08f; //EIM 0.2f
static const float 	SNOW_CAM_MIN 				= 50.0f; //EIM 50.0f
static const float 	SNOW_CAM_MAX 				= 100.0f; //EIM 300.0f
...
static const float COLORMAP_OVERLAY_STRENGTH 	= 0.75f; //0.7f; //EIM 0.75f
...
static const float 	FOG_END 					= 50.0f; // EIM 150.0f
static const float 	FOG_MAX 					= 0.15f; // EIM 0.35f

//static const float 	FOG_MAX 					= 1000.7f;

// Fog of war
static const float 	FOW_MAX 					= 0.5f;
static const float  FOW_CAMERA_MIN				= 200; // EIM 200
static const float  FOW_CAMERA_MAX				= 250; // EIM 500
...
static const float  SHADOW_WEIGHT_TERRAIN    	= 0.7f; // EIM 0.7f
static const float  SHADOW_WEIGHT_MAP    		= 0.7f; // EIM 0.7f
...
static const float GB_CAM_MIN = 220.0f; // EIM
static const float GB_CAM_MAX = 225.0f; // EIM
static const float GB_CAM_MAX_FILLING_CLAMP = 0.80f; // 0 to 1 value for clamping the fill when camera is at max distance // EIM 0.8f
static const float GB_THRESHOLD = 0.5f; // interpolation time // EIM
static const float GB_THRESHOLD2 = 0.04f; // interpolation time // EIM smaller the number, thinner the edges
...
static const float GB_STRENGTH_CH1 = 1.00; // Opacity of bottom layer
static const float GB_STRENGTH_CH2 = 0.30; // Opacity of top layer // EIM 0.2 or 0.55 (LOWER MEANS BRIGHTER) 
